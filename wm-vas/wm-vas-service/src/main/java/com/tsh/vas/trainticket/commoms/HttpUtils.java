package com.tsh.vas.trainticket.commoms;
...
public class HttpUtils {
    ...
    public static String doPost(String path, Map<String, Object> params) {
        return post(path, "POST", parse(params,charset_utf8),"application/x-www-form-urlencoded",charset_utf8);
    }
    ...
    public static String doGet(String path, Map<String, Object> params) {
        return post(path, "GET", parse(params,charset_utf8),"application/x-www-form-urlencoded",charset_utf8);
    }
