...
public class ResponseMessage {
     ...
     * 输出参数
     */
    private String outParmeters;


    public String getOutParmeters() {
        return outParmeters;
    }


    public void setOutParmeters(String outParmeters) {
        this.outParmeters = outParmeters;
    }
    ...
    public boolean hasError(){
        return (!this.code.equals(String.valueOf(SystemCodes.SUCCESS_CODE)));
    }
