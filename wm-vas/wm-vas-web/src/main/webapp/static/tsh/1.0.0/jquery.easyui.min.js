...
(function($){
  ...
  $.messager={
		  ...
		  errortip:function(_2b6,msg,errorinfo,fn){
		    var opts=typeof _2b6=="object"?_2b6:{title:_2b6,msg:msg,errorinfo:errorinfo,fn:fn};
		    var cls="messager-icon messager-error";
		    opts=$.extend({},$.messager.defaults,{
		    	content:"<div class=\""+cls+"\"></div>"+"<div>"+opts.msg+"</div>"+"<div style=\"clear:both;\"/>" +
		    			"<div style='height:20px;margin-top: 4px;font-size: 12px;'>错误详情:<span>"+opts.errorinfo+"</span></div>"
		    },opts);
		    if(!opts.buttons){
