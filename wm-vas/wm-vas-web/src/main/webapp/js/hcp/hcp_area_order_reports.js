...
$(function () {
    ...
    $("#search").on('click',function(){
        ...
        $("#dataGrid").datagrid('load', {
            ...
            'startDate': $('#startDate').datebox('getValue'), //开始-支付时间
            'endDate': $('#endDate').datebox('getValue'), //结束-支付时间
            'userName': $('#userName').textbox('getValue'),	//乘车人
            'idCardId': $('#idCardId').textbox('getValue'),	//乘车人身份证
            'linkName': $('#linkName').textbox('getValue'), //购票联系人姓名
            'linkPhone': $('#linkPhone').textbox('getValue'), //购票联系人电话
            'payStatus': $('#payStatus').combobox('getValue'), //订单状态
            'storeName': $('#storeName').combobox('getText'), //所属区域-网点
            'status': $('#status').combobox('getValue')  //退款状态
        });
    });
    ...
    $("#export").on('click', function () {
        ...
        url = url + "&storeName=" + $('#storeName').textbox('getValue');
